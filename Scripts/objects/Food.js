...
(function (objects) {
    var Food = /** @class */ (function (_super) {
        ...
        // CONSTRUCTOR
        function Food() {
            var _this = _super.call(this, config.Game.ASSETS.getResult("food"), new objects.Vector2(), true) || this;
            _this.Start();
            return _this;
        }
        // PRIVATE METHODS
        ...
        Food.prototype._move = function () {
            this.position = objects.Vector2.add(this.position, this.velocity);
        };
        // PUBLIC METHODS
        Food.prototype.Start = function () {
            this.type = enums.GameObjectType.FOOD;
